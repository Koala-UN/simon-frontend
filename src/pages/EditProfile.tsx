...
function EditProfile() {
  ...
  const { isAuthenticated, user, setUser, logout, setIsAuthenticated } = useAuth();
  ...
  const handleDeleteAccount = async () => {
    try {
      ...
      if (response.ok) {
        ...
        setUser({ id: 0, nombre: "", correo: "", imageUrl: "" });
          ...
          <>
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <textarea
                ...
                onChange={handleInputChange}
                className="border rounded-lg px-3 py-2 py-11"
              ...
              <Button
                ...
                className="w-full mt-60 flex items-center justify-center gap-2" placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}                            >
