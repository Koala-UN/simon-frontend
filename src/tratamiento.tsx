...
La sociedad SIMON, con domicilio en Bogotá D.C., correo electrónico koalasimonapp@gmail.com y teléfono 300 7102511, informa a los Titulares de Datos Personales que sean tratados de cualquier forma por SIMON acerca de esta política de tratamiento de información, en cumplimiento de la Ley 1581 de 2012 y el Decreto 1377 de 2013. 

El objetivo principal de esta Política es informar a los Titulares de los Datos Personales sobre sus derechos, los procedimientos y mecanismos establecidos por SIMON para garantizar el ejercicio de dichos derechos, así como dar a conocer el alcance y propósito del Tratamiento al que serán sometidos los Datos Personales, siempre que el Titular otorgue su autorización previa, expresa e informada.
...
Para garantizar el correcto funcionamiento de la plataforma de SIMON, la recolección de datos personales de los clientes se limitará exclusivamente a la información necesaria para gestionar su reserva en los restaurantes. Estos datos incluyen el nombre completo, para identificar al titular de la reserva; el número de teléfono, que permitirá contactar al cliente en caso de cambios, confirmaciones o recordatorios relacionados con su reserva,  fecha y hora de la reserva y el correo electrónico, que será utilizado para enviar notificaciones como la confirmación, modificación o cancelación de la reserva. La recolección se llevará a cabo a través de la aplicación web, garantizando que el proceso sea claro y eficiente para los usuarios.

También se recolectarán datos sobre los pedidos realizados a través de la plataforma para permitir una trazabilidad efectiva, garantizar que los pedidos lleguen correctamente al restaurante y brindar un servicio más personalizado. Estos datos serán útiles para resolver posibles inconvenientes con los pedidos, realizar análisis estadísticos y mejorar los servicios ofrecidos por la plataforma. Este enfoque asegura que la recolección de datos esté alineada con el principio de finalidad, utilizando únicamente la información necesaria para cumplir con el objetivo del servicio.

FORMA DE RECOLECCIÓN DE DATOS A ALIADOS COMERCIALES 

Para garantizar el correcto funcionamiento de la plataforma de SIMON, se recolectarán los siguientes datos personales de los aliados comerciales: nombre completo del encargado de la cuenta, que servirá como punto de contacto directo; su correo electrónico y número de teléfono, que permitirán una comunicación eficiente; y la dirección del restaurante, para fines logísticos y administrativos. La información recolectada estará orientada a identificar plenamente a los representantes y negocios asociados. También se solicitará el nombre del restaurante y, de ser relevante, el número de identificación tributaria (NIT) para garantizar un manejo adecuado de las obligaciones legales y contractuales. Estos datos serán recolectados a través de formularios en línea o comunicaciones directas entre el aliado y la empresa, asegurando que se cumpla con los principios de finalidad y proporcionalidad.

Adicionalmente, se recopilarán datos relacionados con las reservas realizadas en el restaurante y los pedidos gestionados a través de la plataforma. Esta información permitirá evaluar la demanda y el desempeño del aliado comercial, garantizar la calidad del servicio ofrecido y optimizar las operaciones del restaurante. Estos datos se recolectarán de manera transparente y siempre en cumplimiento con los principios de legalidad y proporcionalidad.

FINALIDADES DEL TRATAMIENTO DE LOS DATOS PERSONALES

FINALIDADES DEL TRATAMIENTO DE LOS DATOS DE CLIENTES

La información recolectada de los clientes se utilizará principalmente para cumplir con el servicio solicitado, es decir, gestionar las reservas y pedidos realizados en los restaurantes. Los datos sobre las reservas permitirán garantizar la correcta asignación de mesas, enviar confirmaciones, realizar modificaciones solicitadas por el cliente y gestionar cancelaciones. Por otro lado, los datos de los pedidos permitirán supervisar que los mismos se gestionen adecuadamente por parte del restaurante, ofrecer soporte en caso de inconvenientes y realizar análisis para mejorar la calidad del servicio.

FINALIDADES DEL TRATAMIENTO DE LOS DATOS DE ALIADOS COMERCIALES

Los datos recopilados de los aliados comerciales tienen como objetivo administrar de manera eficiente la relación contractual y operativa con la plataforma. Esto incluye el manejo de reservas realizadas en sus restaurantes y los pedidos gestionados a través de la plataforma. La información permitirá verificar la correcta ejecución de los servicios ofrecidos, garantizar que los pedidos sean entregados de manera adecuada y evaluar el desempeño general del aliado. La plataforma garantizará que esta información sea tratada de forma segura y únicamente con las finalidades previamente autorizadas.
...
Para utilizar los servicios ofrecidos en la plataforma SIMON, todos los visitantes deben registrarse y otorgar su consentimiento para el tratamiento de sus datos personales. Por ello, en cada uno de los sistemas se incluye una casilla denominada “Política de privacidad y Tratamiento de Datos Personales”, que es imprescindible leer y aceptar para continuar accediendo a los servicios de SIMON.
OFICIAL DE PROTECCIÓN DE DATOS PERSONALES
SIMON ha designado a Martin Polanco Barrero identificado con la cédula 1005755060 como oficial de protección de datos personales y responsable de la recepción y atención de consultas, quejas y reclamos de todo tipo relacionadas con los Datos Personales. La persona encargada tramitará las consultas y reclamaciones en materia de Datos Personales de conformidad con la Ley y esta política.
...
Dirección física: Cra 17 #93A-38, dirección electrónica koalasimonapp@gmail.com y teléfono 3007102511
CANALES DE COMUNICACIÓN Y MECANISMOS DISPUESTOS POR SIMON
En cumplimiento de la garantía constitucional del Habeas Data, que protege los derechos de acceso, actualización, rectificación y supresión de datos personales por parte de sus Titulares, así como de sus causahabientes, representantes legales y/o apoderados, SIMON  dispondrá de canales de comunicación para dichos Titulares.
Todas las solicitudes, consultas, quejas y/o reclamos deberán ser dirigidos al Oficial de Protección de Datos Personales, a través de los siguientes medios:
Atención electrónica: Los Titulares podrán realizar su solicitud mediante el correo electrónico koalasimonapp@gmail.com.
Atención escrita: Los Titulares deberán remitir sus requerimientos de manera formal a la dirección: Cra 17 #93A-38, Bogotá, Colombia.
Por estos medios, los Titulares tendrán la posibilidad de eliminar sus Datos Personales almacenados en Rappi en cualquier momento mediante las diversas plataformas disponibles.
PROCEDIMIENTO LEGAL PARA CONSULTAS QUEJAS Y RECLAMOS

Consultas

Tratándose del derecho de petición en calidad de información y/o consultas, SIMON  dará respuesta en un término máximo de diez (10) días hábiles contados a partir del día siguiente a la fecha de recepción de la petición o consulta.
...
SIMON no recolectará datos personales sensibles bajo ninguna circunstancia, en línea con el artículo 6 de la Ley 1581 de 2012

VIGENCIA

Los Datos Personales que sean almacenados, utilizados o transmitidos permanecerán en las bases de datos de SIMON  durante el tiempo que sea necesario para cumplir con las finalidades expuestas en este manual o para que la Empresa pueda cumplir con sus deberes legales.

De ser necesario SIMON se reserva el derecho a modificar la presente Política de forma unilateral.
